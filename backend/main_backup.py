...
def enhance_transcript_with_gemini(transcript_data, video_info):
    ...
    try:
        ...
        prompt = f"""
You are an expert content analyst specializing in creating comprehensive, well-structured video summaries. Your task is to analyze the provided video content and create a professional summary that captures all important information while being engaging and easy to read.
...
INSTRUCTIONS:
Create a comprehensive video summary that includes ALL important information from this video. The summary should be:

1. **COMPREHENSIVE**: Include all major points, key insights, and important details
2. **WELL-STRUCTURED**: Use clear headings and logical organization
3. **TIMESTAMPED**: Include specific timestamps [MM:SS] for all major topics and key moments
4. **INFORMATIVE**: Capture both factual content and context/insights
5. **BALANCED**: Neither too brief (missing important info) nor excessively long
6. **ACTIONABLE**: Include practical takeaways where relevant

Required Structure:

## 🎯 EXECUTIVE SUMMARY
[2-3 sentences capturing the main topic and purpose]

## 🔑 KEY TAKEAWAYS
[5-8 bullet points of the most important insights and learnings]

## 📋 DETAILED CONTENT BREAKDOWN
[Organized by topics/sections with timestamps, covering ALL major content]

### [Timestamp] Topic Name
[Detailed explanation of what's covered in this section]

## 💡 IMPORTANT QUOTES & INSIGHTS
[Notable quotes, statistics, or key insights with timestamps]

## 🎯 ACTION ITEMS & RECOMMENDATIONS
[If applicable - practical steps, recommendations, or things to remember]

## 📊 ADDITIONAL CONTEXT
[Background information, related topics, or interesting facts mentioned]

Focus on creating a summary that someone could read and understand 80-90% of the video's value without watching it, while still encouraging them to watch for the full experience. Include specific timestamps throughout so readers can jump to relevant sections.

Make sure to include ALL important information - this should be a comprehensive resource, not a brief overview.
"""
...
- Make it engaging and valuable for someone who wants to understand the video's content
- Include specific details, quotes, examples, and actionable insights where relevant
- Maintain accuracy to the original content while making it accessible

The summary should help someone understand 80-90% of the video's value and decide if they want to watch the full video.
